        ...
        <div class="container-registration">
            <div class="forms-container">
                <div class="row no-gutters">
                  <div class="col-2">
                    <form action="registration7.php" method="POST">
                ...
                <div class="container">
                  <p class="face-position">Wajah Menghadap Serong Kanan Sedikit Dengan Masker</p>
                  ...
                  <img src="image/S__14721050.jpg" style="width:100px;height:120px;margin-bottom:20px;">
                  <div id="my_camera"></div>
                  <br> <button type="button" onclick = "previewSnap();">CAPTURE</button> <br>
                  <div id="result" ></div>
                  <br> <button1 type="button" onclick = "saveSnap();">SAVE</button1> <br>
                  <a href="registration9.php"> <button2 type="button">NEXT &#x2192;</button> </a>
                </div>
                ...
                <script type="text/javascript">
                  ...
                  function saveSnap(){
                    ...
                    Webcam.upload(base64image,'function.php',function(code,text){
                      ...
                      document.location.href = "registration8.php"
                    });
                  }
                  </script>
            </div>
