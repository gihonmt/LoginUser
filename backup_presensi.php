            ...
            <div class="forms-container">
                <div class="row no-gutters">
                  ...
                  <div class="col-10">
                    <div class="header-registration">
                        <p class="header-registration-description">BACK-UP PRESENCE</p>
                    </div>
                  </div>
                </div>
                <div class="container">
                  <p class="face-position">Pastikan Wajah Terlihat Jelas</p>
                ...
                <script type="text/javascript">
                  ...
                  function saveSnap(){
                    ...
                    Webcam.upload(base64image,'function_backup.php',function(code,text){
